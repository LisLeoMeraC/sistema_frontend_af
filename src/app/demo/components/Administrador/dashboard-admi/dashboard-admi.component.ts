...
@Component({
    ...
    styleUrls: ['./dashboard-admi.component.scss'],
})
export class DashboardAdmiComponent {
    ...
    obtenerTopArticulosVendidos() {
        this.articuloService.obtenerTopArticulosVendidos().subscribe({
            ...
            error: (err) => {
                console.error(
                    'Error al obtener los artículos más vendidos',
                    err
                );
            },
        });
    ...
    obtenertotalArticulosPorCaducar() {
        this.articuloService.contarAriculosProximoCaducar().subscribe({
            ...
            error: (err) => {
                console.error(
                    'Error al contar articulos proximos a caducar',
                    err
                );
            },
        });
    ...
    obtenerArticulosPorCaducar() {
        this.articuloService.obtenerArticulosPorCaducar().subscribe({
            ...
            error: (err) => {
                console.error(
                    'Error al obtener los artículos por caducar',
                    err
                );
            },
        });
